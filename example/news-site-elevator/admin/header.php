    ...
    <body>
        ...
        <div id="header-admin">
            ...
            <div class="container">
                ...
                ?>
                        <!-- <a href="post.php"><img class="logo" src="../images/IMGIMG_20170101_060235_044.jpg"></a> -->
                    </div>
                    <!-- /LOGO -->
                      <!-- LOGO-Out -->
                    <div class="col-md-offset-6  col-md-4 text-white">
                ...
                <div class="row">
                    <div class="col-md-12">
                       <ul class="admin-menu">
                            ...
                            <li>
                                <a href="manage-about.php">About Page</a>
                            </li>
                            <li>
                                <a href="manage-privacy.php">Privacy Page</a>
                            </li>
                            <li>
