...
<div id="admin-content">
  ...
  <div class="row">
    <div class="col-md-12">
        <h1 class="admin-heading">Manage Privacy Page</h1>
    </div>
      ...
      $content = '';
        ...
        if(mysqli_num_rows($result) < 1){
           if (isset($_POST['submit'])) {
            ...
            $insert_content = "insert into privacy(privacy) values('$content')";
            $query = mysqli_query($conn, $insert_content);
            if ($query) {
               header("location: manage-privacy.php");
               die();
            }
        }
         ...
         if (isset($_POST['submit'])) {
            ...
            $update_content = "update privacy set privacy='$content' where id = '$id'";
