                    ...
                    <div class="post-container">
                      ...
                      ?>
                        ...
                        if(mysqli_num_rows($result1) > 0){
                          ...
                          if($page > 1){
                            echo '<li><a class="index-pages" href="index.php?page='.($page - 1).'">Prev</a></li>';
                          }
                          for($i = 1; $i <= $total_page; $i++){
                            ...
                            echo '<li class="'.$active.'"><a class="index-pages" href="index.php?page='.$i.'">'.$i.'</a></li>';
                          }
                          if($total_page > $page){
                            echo '<li><a class="index-pages" href="index.php?page='.($page + 1).'">Next</a></li>';
                          }
