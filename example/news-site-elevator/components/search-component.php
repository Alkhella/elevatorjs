            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  if(isset($_GET['search'])){
                    $search_term = mysqli_real_escape_string($conn, htmlspecialchars(trim($_GET['search'])));
                  ?>
                  ...
                  ?>
                    ...
                    if(mysqli_num_rows($result1) > 0){
                      ...
                      if($page > 1){
                        echo '<li><a class="search-pages" href="search.php?search='.$search_term .'&page='.($page - 1).'">Prev</a></li>';
                      }
                      for($i = 1; $i <= $total_page; $i++){
                        ...
                        echo '<li class="'.$active.'"><a class="search-pages" href="search.php?search='.$search_term .'&page='.$i.'">'.$i.'</a></li>';
                      }
                      if($total_page > $page){
                        echo '<li><a class="search-pages" href="search.php?search='.$search_term .'&page='.($page + 1).'">Next</a></li>';
                      }
