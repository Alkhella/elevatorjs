        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  if(isset($_GET['cid'])){
                    $cat_id = mysqli_real_escape_string($conn, htmlspecialchars(trim($_GET['cid'])));
                  ...
                  ?>
                    ...
                    if(mysqli_num_rows($result1) > 0){
                      ...
                      if($page > 1){
                        echo '<li><a class="cat-url" href="category.php?cid='.$cat_id .'&page='.($page - 1).'">Prev</a></li>';
                      }
                      for($i = 1; $i <= $total_page; $i++){
                        ...
                        echo '<li class="'.$active.'"><a class="cat-url" href="category.php?cid='.$cat_id .'&page='.$i.'">'.$i.'</a></li>';
                      }
                      if($total_page > $page){
                        echo '<li><a class="cat-url" href="category.php?cid='.$cat_id .'&page='.($page + 1).'">Next</a></li>';
                      }
